...
use crate::gog::components::game::GameElement;
use crate::gog::components::list::GameList;
...
impl Component for GogContentElement
{
	fn render(&self) -> impl IntoElement
	{
		...
		let selectedGameId = use_radio::<Option<u64>, GameIdChannel>(GameIdChannel::Gog);
