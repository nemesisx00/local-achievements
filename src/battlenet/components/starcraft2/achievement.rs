...
use freya::prelude::{Alignment, Border, BorderAlignment, ChildrenExt, Component, ContainerExt, ContainerSizeExt, ContainerWithContentExt, Content, Direction, Gaps, ImageViewer, IntoElement, Size, StyleExt, TextAlign, TextStyleExt, label, rect};
use freya::radio::use_radio;
use crate::battlenet::platform::api::BattleNetApi;
use crate::battlenet::platform::starcraft2::Starcraft2;
use crate::constants::{BorderColor, CornerRadius, Format_ChronoDateTime};
...
impl Component for Sc2Achievement
{
	fn render(&self) -> impl IntoElement
	{
		...
		let achievement = appData.read().user.battleNet.starcraft2
			.clone()
			.unwrap_or_default()
