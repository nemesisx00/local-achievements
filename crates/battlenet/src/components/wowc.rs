...
pub fn wowcElement() -> WorldOfWarcraftClassicElement
{
	return WorldOfWarcraftClassicElement {};
}

#[derive(Clone, PartialEq)]
pub struct WorldOfWarcraftClassicElement;

impl Component for WorldOfWarcraftClassicElement
{
