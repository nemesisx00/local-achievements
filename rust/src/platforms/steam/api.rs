...
impl Api
{
	pub const GameIcon: &'static str = "game-icon.jpg";
	pub const Platform: &'static str = "Steam";
	
	const Protocol: &'static str = "https://";
	const Domain: &'static str = "api.steampowered.com/";
	
	const Service_Player: &'static str = "IPlayerService";
	const Service_User: &'static str = "ISteamUser";
	const Service_UserStats: &'static str = "ISteamUserStats";
	
	const Endpoint_GetGlobalAchievementPercentagesForApp: &'static str = "GetGlobalAchievementPercentagesForApp/v0002";
	const Endpoint_GetOwnedGames: &'static str = "GetOwnedGames/v0001";
	const Endpoint_GetPlayerAchievements: &'static str = "GetPlayerAchievements/v0001";
	const Endpoint_GetPlayerSummaries: &'static str = "GetPlayerSummaries/v0002";
	const Endpoint_GetRecentlyPlayedGames: &'static str = "GetRecentlyPlayedGames/v0001";
	const Endpoint_GetSchemaForGame: &'static str = "GetSchemaForGame/v0002";
	
	pub const Language_English: &'static str = "english";
	
	const Parameter_AppId: &'static str = "appid";
	const Parameter_Format: &'static str = "format";
	const Parameter_GameId: &'static str = "gameid";
	const Parameter_IncludeAppInfo: &'static str = "include_appinfo";
	const Parameter_IncludePlayedFreeGames: &'static str = "include_played_free_games";
	const Parameter_Key: &'static str = "key";
	const Parameter_Language: &'static str = "l";
	const Parameter_SteamId: &'static str = "steamid";
	const Parameter_SteamIds: &'static str = "steamids";
	
	const Format_Json: &'static str = "json";
	
	const Value_False: &'static str = "0";
	const Value_True: &'static str = "1";
	
	const Replace_AppId: &'static str = "{appid}";
	const Replace_Hash: &'static str = "{hash}";
	const Replace_Size: &'static str = "{size}";
	
	//const IconUrl_Achievement: &'static str = "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/apps/{appid}/{hash}.jpg";
	const IconUrl_Game: &'static str = "https://media.steampowered.com/steamcommunity/public/images/apps/{appid}/{hash}.jpg";
	
	const AvatarUrl: &'static str = "https://avatars.steamstatic.com/{hash}{size}.jpg";
	const AvatarUrl_ReplaceMedium: &'static str = "_medium";
	const AvatarUrl_ReplaceFull: &'static str = "_full";
